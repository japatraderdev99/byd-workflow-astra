...
b=ROOT/'Projects/BYD/Jobs/V4';lines=(b/'WORK/06_LOGS/build_production_r10.log').read_text().splitlines();rows=[]
for line in lines:
...
q=b/'WORK/04_QA/production-r10';q.mkdir(exist_ok=True);out=q/f'geometry_{len(rows)}.json'
