...
/*
  ...
  Prepared for production_spec_r07.json. Static review required before execution.
...
var sf = new File(BASE + 'WORK/00_MATRIZ/production_spec_r07.json');
if (!sf.exists) throw Error('MISSING_SPEC');
sf.encoding = 'UTF8'; sf.open('r'); var spec = eval('(' + sf.read() + ')'); sf.close();
log = new File(BASE + 'WORK/06_LOGS/build_production_r07.log');
...
try {
 ...
 msg('SCRIPT_PREPARED|build_production_r07.jsx|derived=build_production_r05|change=cropped_detail_qa_only|expected_pngs=' + expectedPngCount + '|review_required=true');
