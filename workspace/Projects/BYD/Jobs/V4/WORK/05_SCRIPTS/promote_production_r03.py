...
b=ROOT/'Projects/BYD/Jobs/V4';qa=b/'WORK/04_QA/production-r03';tech=json.loads((qa/'technical_all.json').read_text());visual=json.loads((qa/'head_visual_review.json').read_text());approved={x['file']:x for x in visual['files'] if x['status']=='PASS'}
