...
/*
  ...
  Prepared for production_spec_probe_r02.json. Static review required before execution.
...
var sf = new File(BASE + 'WORK/00_MATRIZ/production_spec_probe_r02.json');
if (!sf.exists) throw Error('MISSING_SPEC');
sf.encoding = 'UTF8'; sf.open('r'); var spec = eval('(' + sf.read() + ')'); sf.close();
log = new File(BASE + 'WORK/06_LOGS/probe_r02.log');
