#!/usr/bin/env python3
"""Prepare a non-overlapping native timing report for the R11 assembly.
...
OUT = V4 / "WORK/04_QA/production_timings_r11.json"
RUN_LOGS = [
    ...
    ("reuse_r13", "render_reuse_r13.log"),
]
...
def main() -> None:
    ...
    report = {
        "schema": "byd-v4-production-timings-r11/v1",
    ...
    print("OK|production_timings_r11|runs=" + str(len(runs)))
