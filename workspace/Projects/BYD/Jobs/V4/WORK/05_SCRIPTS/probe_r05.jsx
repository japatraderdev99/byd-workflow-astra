...
/*
  ...
  Prepared for production_spec_probe_r05.json. Static review required before execution.
...
var sf = new File(BASE + 'WORK/00_MATRIZ/production_spec_probe_r05.json');
if (!sf.exists) throw Error('MISSING_SPEC');
sf.encoding = 'UTF8'; sf.open('r'); var spec = eval('(' + sf.read() + ')'); sf.close();
log = new File(BASE + 'WORK/06_LOGS/probe_r05.log');
...
try {
 ...
 if (!spec.formats || spec.formats.length !== 1) throw Error('EXPECTED_6_FORMATS');
 ...
 msg('SCRIPT_PREPARED|build_production_r05.jsx|derived=build_production_r03|change=performance_cache_only|expected_pngs=' + expectedPngCount + '|review_required=true');
