...
/*
  R14 cold post-production patch for confirmed BYD review findings.
  ...
  1. In the two confirmed landscape formats, tighten only the bottom of the
     ...
     R14 keeps the full car zone (100%) and feathers the new bottom edge by at
  ...
  R14 runtime correction: activate the target state before every visibility
...
var LOG_REL = 'WORK/06_LOGS/patch_controle_r14.log';
var OUT_TPL_REL = 'WORK/01_TEMPLATES/2026-09-20-r14/';
var OUT_PNG_REL = 'WORK/03_STAGING/2026-09-20-r14/';
...
function preflightOutputs() {
 ...
 if (!outDir.exists || !pngDir.exists) throw Error('MISSING_R14_OUTPUT_FOLDER');
