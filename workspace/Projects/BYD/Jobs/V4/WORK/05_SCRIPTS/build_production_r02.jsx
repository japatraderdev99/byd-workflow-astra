...
/*
  ...
  Prepared for production_spec_r02.json. Static review required before execution.
...
var sf = new File(BASE + 'WORK/00_MATRIZ/production_spec_r02.json');
if (!sf.exists) throw Error('MISSING_SPEC');
sf.encoding = 'UTF8'; sf.open('r'); var spec = eval('(' + sf.read() + ')'); sf.close();
log = new File(BASE + 'WORK/06_LOGS/build_production_r02.log');
...
try {
 ...
 preflightOutputs();
 msg('SCRIPT_PREPARED|build_production_r02.jsx|derived=build_production_r01|fix=anchor_index_path|patches=p16,p18|review_required=true');
