...
var log=new File(BASE+'WORK/06_LOGS/photoshop_inspect_v2.tsv');
...
try {
 ...
 var profile='SEM_PERFIL';try{profile=doc.colorProfileName;}catch(ignore){}
 log.writeln('DOC\t'+doc.width.as('px')+'\t'+doc.height.as('px')+'\t'+profile);
