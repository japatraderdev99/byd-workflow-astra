# BYD TPL r03 — 1920×1080

`REFUSE_OVERWRITE`. Especificação: `WORK/00_MATRIZ/production_spec_r03.json`; família landscape, grade de segurança 45 px, escopo planejado 20 ofertas neste formato (140 peças nos 7 formatos). Zonas previstas: tag `[970,205,240,50]`, badges `[1100,790,360,65]`, award `[1760,790,65,65]`.
