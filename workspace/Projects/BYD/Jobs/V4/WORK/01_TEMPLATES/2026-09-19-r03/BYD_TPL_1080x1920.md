# BYD TPL r03 — 1080×1920

`REFUSE_OVERWRITE`. Especificação: `WORK/00_MATRIZ/production_spec_r03.json`; família portrait, grade de segurança 45 px, escopo planejado 20 ofertas neste formato (140 peças nos 7 formatos). Zonas previstas: tag `[100,640,240,45]`, badges `[480,1240,400,65]`, award `[930,1240,65,65]`.
