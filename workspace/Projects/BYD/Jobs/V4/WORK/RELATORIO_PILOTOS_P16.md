# BYD V4 — revisão visual P16

Registro: 2026-09-19T22:12:23.697183-03:00. Estado: PILOTOS PARA REVISAO; F1 completo e escala pendentes.
...
QA técnico: 21/21 PNGs nas dimensões corretas, RGB8, opacos, sRGB embutido; 7/7 PSDs com grupos obrigatórios. Flags estruturais de NEW oculto e exclusividade do micro verificadas. Manifesto com hashes: `WORK/04_QA/qa_p16_20260919.json`. Esse resultado não aprova composição ou conteúdo.
...
|---|---:|---:|---:|
| P16_TRIAL_1080x1080 | 751.6 MB | 25 | 23 |
| P16_TRIAL_1080x1920 | 780.1 MB | 25 | 23 |
| P16_TRIAL_1109x1973 | 783.0 MB | 25 | 23 |
| P16_TRIAL_1920x1080 | 780.9 MB | 25 | 23 |
| P16_TRIAL_1920x1125 | 781.2 MB | 25 | 23 |
| P16_TRIAL_1920x276 | 748.6 MB | 25 | 23 |
| P16_TRIAL_360x80 | 715.6 MB | 25 | 23 |
...
P12, construção de sete rascunhos/21 renders: 588,109 s. P16, ajuste/reabertura/salvamento/exportação: 330.937 s. QA técnico P16: 134.959 s. Os tempos abaixo são trechos do script P16; incluem I/O. Não são tempo por template aprovado.
...
Primeiro carimbo do run: 19/09/2026 12:05:22 -03:00. Este registro: 19/09/2026 22:12:23 -0300. A janela inclui intervalos não instrumentados; tempo ativo total e custo por tarefa não estão medidos. Tokens/custo monetário/modelo observado: não estimados. Há retrabalho relevante: esta primeira execução ainda não comprova o custo-benefício pretendido.
